...
const course: Course = {
  "code": "MAT 1004",
  "name": "Álgebra Lineal",
  "unit": "Instituto de Matemáticas (Ciencias Básicas)",
  "intro": "Este curso obligatorio del área de Ciencias Básicas busca desarrollar habilidades lógico-matemáticas enfocadas a la resolución algorítmica y abstracta dentro de espacios vectoriales. Esta guía le acompañará en el diseño y alineación de sus estrategias docentes y evaluativas.",
  "dimensions": [
    {
      "id": 1,
      "proposito": "¿Hacia dónde apuntamos? Al enseñar Álgebra Lineal, no solo resolvemos ecuaciones, sino que formamos la capacidad del futuro ingeniero para abstraer, analizar y modelar la realidad.",
      "contexto": "El estudiante demuestra capacidad científica, de análisis, abstracción, síntesis y reflexión crítica para resolver problemas. También integra conocimientos de ciencias básicas y de ingeniería.",
      "aplicacionTitle": "Ideas para el Aula: Conectando con el Perfil",
      "aplicacionDesc": "Estrategia sugerida: 'Modelamiento Matemático Crítico'. En lugar de entregar los sistemas lineales listos, presente un problema de ingeniería abierto. El desafío es que los estudiantes deban identificar las variables, construir el sistema de ecuaciones y evaluar críticamente si la solución es físicamente posible.",
      "competencias": [
        {
          "codigo": "C-AB",
          "texto": "Abstrae, analiza y modela la realidad mediante estructuras del álgebra lineal."
        },
        {
          "codigo": "C-RE",
          "texto": "Resuelve sistemas lineales con rigor operatorio y verifica sus soluciones."
        },
        {
          "codigo": "C-AP",
          "texto": "Aplica el álgebra abstracta a problemas propios de la ingeniería."
        }
      ]
    },
    {
      "id": 2,
      "proposito": "Las competencias de la asignatura tienden el puente entre el álgebra abstracta y su aplicación pragmática en la ingeniería: abstraer problemas a sistemas lineales, resolverlos con rigor e interpretar sus soluciones. La asignatura tributa a varias competencias del perfil del ingeniero de forma simultánea.",
      "contexto": "En este curso, de carácter teórico-aplicado, los estudiantes desarrollarán habilidades para la resolución de problemas algebraicos de carácter lineal en varias variables dentro de espacios vectoriales.",
      "aplicacionTitle": "Ideas para el Aula: Movilizando la Competencia",
      "aplicacionDesc": "Estrategia sugerida: 'Laboratorio de Resolución Vectorial'. Diseñe clases activas poniendo énfasis en el saber hacer. Utilice software o TIC's para que manipulen transformaciones lineales y calculen valores propios observando de forma gráfica e iterativa los resultados en el plano y en el espacio."
    },
    {
      "id": 3,
      ...
      "contexto": "RA1: Resuelve sistemas de ecuaciones con métodos matriciales. RA2: Aplica la geometría vectorial para generalizar el concepto de espacio vectorial. RA3: Interpreta resultados para resolver problemas de ingeniería.",
      "aplicacionTitle": "Ideas para el Aula: Evidenciando los Resultados",
      "aplicacionDesc": "Estrategia sugerida: 'Taller Colaborativo de Interpretación Geométrica' (Para el RA2 y RA3). Proponga tareas individuales y de trabajo colaborativo donde, tras calcular distancias, proyecciones ortogonales y matrices de cambio de base, deban interpretar y defender qué significa el resultado en un contexto ingenieril específico."
    },
    {
      "id": 4,
      "proposito": "¿Cómo recogeremos la información del aprendizaje? El programa estipula un modelo que combina un fuerte peso en la evaluación sumativa de cátedra, equilibrado con evaluaciones de proceso o colaborativas.",
      "contexto": "El programa determina una nota de presentación equivalente al 80% proveniente de tres pruebas de cátedra, y un 20% conformado por trabajos grupales, controles y/o tareas.",
      "aplicacionTitle": "Distribución Oficial de Procedimientos",
      "aplicacionDesc": "• Pruebas de Cátedra (80%): Para evaluar la solidez del razonamiento y exactitud en la operatoria de matrices y espacios vectoriales.\n• Trabajos Grupales y/o Tareas (20%): Evaluaciones continuas para monitorear el desempeño en resolución colaborativa o el uso de TIC's.\n• Examen: Se eximen los promedios mayores o iguales a 4,5. En caso de examen, pondera el 33% de la Nota Final (NF= 0,67 NP + 0,33 NE)."
    },
    {
      "id": 5,
      "proposito": "¿En qué nos vamos a fijar al corregir? Los criterios transparentan lo que valoramos. En ciencias básicas, no solo importa el resultado final, sino el rigor metodológico, la justificación y la ausencia de falacias lógicas.",
      "contexto": "Descomponemos los resultados en acciones observables: aplicar métodos conociendo sus restricciones, generalizar mediante abstracción e interpretar analíticamente.",
      "aplicacionTitle": "Ejemplos de Criterios Clave para Álgebra Lineal",
      "aplicacionDesc": "• Criterio Operativo/Algorítmico: 'Calcula correctamente la inversa, determinantes y resuelve sistemas utilizando el método de Gauss-Jordan o Cramer'.\n• Criterio de Abstracción: 'Caracteriza subespacios vectoriales, demostrando dependencia o independencia lineal de manera rigurosa'.\n• Criterio Interpretativo: 'Formula e interpreta geométricamente y físicamente las soluciones obtenidas para R2 y R3'."
    },
    {
      "id": 6,
      "proposito": "¿Con qué herramienta calificamos? Para las Pruebas de Cátedra requerimos Tablas de Especificaciones que aseguren cobertura, mientras que para los Trabajos Grupales necesitamos pautas o rúbricas de corrección.",
      "contexto": "Seleccionar el instrumento asegura coherencia. Las clases activas con énfasis en el 'saber hacer' requieren instrumentos que valoren el proceso tanto como el cálculo final.",
      ...
      "examples": [
        {
          ...
          "source": "(Equivalente al 80% de NP)",
          "desc": "Asegura la validez de contenido al diseñar cada una de las tres pruebas estandarizadas exigidas en el programa.",
          "modalContent": {
            "title": "Tabla de Especificaciones: Espacios Vectoriales",
            "subtitle": "Matriz para asegurar el equilibrio de niveles cognitivos en la evaluación.",
            "items": [
              {
                "label": "Nivel 1: Conocimiento y Operatoría Básica",
                "content": "Foco: Calcular productos vectoriales, normas, ángulos y distancias. Determinar si un conjunto es combinación lineal."
              },
              {
                "label": "Nivel 2: Aplicación y Demostración",
                "content": "Foco: Demostrar dependencia o independencia lineal, obtener las coordenadas respecto a una base y calcular la matriz cambio de base."
              },
              {
                "label": "Nivel 3: Síntesis e Interpretación",
                "content": "Foco: Interpretar geométricamente la intersección de planos o resolver un problema aplicado justificando a través del Teorema de la dimensión."
              }
            ]
          }
        },
        {
          "name": "Rúbrica: Resolución de Problema en Ingeniería",
          "source": "(Evaluación para el Trabajo Grupal - 20%)",
          "desc": "Permite corregir sistemáticamente las tareas grupales o controles aplicados al perfil de egreso.",
          "rubrica": {
            "title": "Rúbrica Analítica: Modelamiento Lineal",
            "subtitle": "Enfocada en evaluar el proceso de abstracción e integración de ciencias básicas.",
            "niveles": [
              "Destacado",
              "Competente",
              "En desarrollo",
            ...
            "criterios": [
              {
                "criterio": "Abstracción del Modelo a Sistema Lineal",
                "niveles": [
                  "Transforma el enunciado ingenieril en un sistema matricial correcto identificando todas las variables.",
                  "Plantea un sistema correcto identificando la mayoría de las variables relevantes.",
                  "Logra un sistema pero omite variables relevantes o plantea ecuaciones redundantes.",
                  "No logra traducir el enunciado a un sistema lineal válido."
                ]
              },
              {
                "criterio": "Rigor en el Cálculo y Resolución",
                "niveles": [
                  "Aplica los métodos (Gauss-Jordan, etc.) sin errores algebraicos y llega al conjunto solución correcto.",
                  "Aplica el método correcto con errores menores que no alteran la solución final.",
                  "Aplica el método con errores operativos que afectan parte de la solución.",
                  "Presenta errores operativos mayores que alteran completamente la solución."
                ]
              },
              {
                "criterio": "Interpretación de la Solución",
                "niveles": [
                  "Verifica las restricciones e interpreta el significado del resultado en el contexto del problema original.",
                  "Interpreta el resultado en el contexto, con verificación parcial de restricciones.",
                  "Interpreta el resultado de forma superficial o sin verificar restricciones.",
                  "No interpreta el resultado ni lo relaciona con el problema planteado."
                ]
              }
            ]
          }
        ...
        {
          "name": "Escala de Apreciación: Taller Práctico/TIC's",
          "source": "(Evaluación Formativa o Control)",
          "desc": "Ideal para clases de ejercitación activa y uso de TIC's en el desarrollo de laboratorios.",
          "modalContent": {
            "title": "Pauta de Desempeño: Uso de TIC's en Geometría",
            "subtitle": "Verifica el 'saber hacer' y la aplicación directa mediante software.",
            "items": [
              {
                "label": "Configuración del Entorno de Trabajo",
                "content": "¿Define correctamente las matrices y/o vectores en el software (R2/R3) respetando la sintaxis del programa?\n[ Logrado / Medianamente Logrado / No Logrado ]"
              },
              {
                "label": "Operatoria Computacional",
                "content": "¿Ejecuta comandos adecuados para obtener la matriz escalonada reducida por filas, rango y determinantes?\n[ Logrado / Medianamente Logrado / No Logrado ]"
              },
              {
                "label": "Validación de Resultados",
                "content": "¿Es capaz de contrastar rápidamente el resultado computacional con el análisis teórico para identificar inconsistencias?\n[ Logrado / Medianamente Logrado / No Logrado ]"
              }
            ]
          }
        }
  ...
  "references": [
    {
      ...
      "cite": "Programa de Asignatura: MAT 1004 - Álgebra Lineal. Pontificia Universidad Católica de Valparaíso."
    },
    {
