  ...
  "dimensions": [
    {
      ...
      "competencias": [
        {
          "codigo": "CD1",
          "texto": "Integra ciencias básicas e ingeniería para resolver problemas complejos de la especialidad."
        },
        {
          "codigo": "CD3",
          "texto": "Selecciona y utiliza técnicas y herramientas tecnológicas apropiadas."
        },
        {
          "codigo": "CP3",
          "texto": "Modela sistemas y procesos para entregar soluciones eficientes."
        },
        {
          "codigo": "CP5",
          "texto": "Diseña métodos de procesamiento inteligente de datos para apoyar la toma de decisiones."
        }
      ]
    },
    {
      "id": 2,
      "proposito": "Las competencias de la asignatura se orientan a resolver problemas asociados con inteligencia humana mediante representación en espacio de estados, métodos de búsqueda, esquemas de representación del conocimiento y sistemas inteligentes. Se evidencian de forma acumulativa (instancias formativas, controles y proyecto) y tributan simultáneamente a varias competencias del perfil del ingeniero.",
      ...
      "examples": [
        ...
        },
        {
          ...
          "rubrica": {
            ...
            "criterios": [
              {
                "criterio": "Definición y acotamiento del problema (30%)",
                "niveles": [
                  "El problema está claramente definido, acotado y formulado en términos de IA (espacio de estados, conocimiento, decisiones).",
                  "El problema está definido y mayormente acotado, con formulación parcial en términos de IA.",
                  "El problema está identificado pero la formulación es demasiado amplia o poco conectada con los conceptos del curso.",
                  "El problema no está definido con claridad ni acotado a un dominio abordable."
                ]
              },
              {
                "criterio": "Pertinencia y justificación del enfoque de IA (40%)",
                "niveles": [
                  "Justifica el enfoque según las características del problema y argumenta por qué descarta las alternativas.",
                  "Justifica el enfoque elegido de forma pertinente, con menor discusión de alternativas.",
                  "Elige un enfoque pero fundamenta débilmente y no descarta alternativas.",
                  "La elección del enfoque parece arbitraria y sin fundamento."
                ]
              },
              {
                "criterio": "Estado de implementación y plan de trabajo (30%)",
                "niveles": [
                  "Hay un prototipo funcional que demuestra viabilidad y un plan realista que cubre los hitos restantes.",
                  "Hay avances de implementación y un plan de trabajo mayormente realista.",
                  "La implementación es incipiente o el plan es vago; hay riesgo de no completar a tiempo.",
                  "No hay implementación ni un plan de trabajo que asegure el término del proyecto."
                ]
              }
            ]
          }
        },
        {
          ...
          "rubrica": {
            ...
            "criterios": [
              {
                "criterio": "Funcionalidad y corrección de la solución (35%)",
                "niveles": [
                  "La solución funciona correctamente, maneja casos borde y produce resultados coherentes con el enfoque implementado.",
                  "La solución funciona correctamente en los casos previstos, con fallas menores en situaciones límite.",
                  "La solución funciona en los casos básicos pero falla en situaciones no triviales o con datos inesperados.",
                  "La solución no funciona de forma confiable ni resuelve el problema definido."
                ]
              },
              {
                "criterio": "Fundamento técnico y justificación de decisiones (35%)",
                "niveles": [
                  "Documenta las decisiones técnicas con argumentos sólidos y compara con alternativas descartadas.",
                  "Justifica las decisiones técnicas principales, con menor discusión de alternativas.",
                  "Describe lo implementado con justificación parcial de las decisiones de diseño.",
                  "Describe lo implementado sin justificar las decisiones ni discutir alternativas."
                ]
              },
              {
                "criterio": "Documentación y calidad del informe técnico (15%)",
                "niveles": [
                  "El informe es reproducible por un lector externo; incluye diagrama de la solución y análisis de resultados.",
                  "El informe es claro y mayormente reproducible, con documentación suficiente.",
                  "El informe describe el código pero no del todo el razonamiento; la reproducción sería difícil.",
                  "El informe no permite entender ni reproducir la solución."
                ]
              },
              {
                "criterio": "Defensa oral y respuesta a preguntas (15%)",
                "niveles": [
                  "Explica con claridad el funcionamiento, responde preguntas técnicas y reconoce las limitaciones del enfoque.",
                  "Explica la solución y responde adecuadamente la mayoría de las preguntas.",
                  "Describe la solución pero responde con dificultad las preguntas sobre diseño o limitaciones.",
                  "No logra explicar ni defender las decisiones de diseño de la solución."
                ]
              }
            ]
          }
