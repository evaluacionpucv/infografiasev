...
const course: Course = {
  ...
  "unit": "Facultad de Ciencias Agronómicas y de los Alimentos",
  "intro": "Esta asignatura busca que el estudiante desarrolle habilidades gerenciales resolviendo casos reales y creando planes de negocio para la industria agroalimentaria. Su diseño evaluativo es de carácter mixto:",
  "dimensions": [
    {
      "id": 1,
      "proposito": "Garantiza que la evaluación final del curso no sea un mero trámite, sino una demostración real de las capacidades requeridas en la vida profesional. Actúa como su 'Norte Estratégico': alinea sus decisiones en el aula con la promesa de formar agrónomos capaces de gestionar empresas con rigor técnico y responsabilidad social.",
      "aplicacionTitle": "¿Cómo lo aplico en mi asignatura?",
      "aplicacionDesc": "Diseñe la evaluación cumbre del semestre preguntándose: '¿Es esto lo que un agrónomo en un cargo directivo hace en la vida real?'. Exija a sus estudiantes que integren variables agronómicas, económicas y de entorno en un Plan de Negocios aplicable al sector silvoagropecuario.",
      "competencias": [
        {
          "codigo": "C-DE",
          "texto": "Gestiona empresas y organizaciones del sector silvoagropecuario integrando criterios técnicos, económicos y de sustentabilidad."
        },
        {
          "codigo": "C-PR",
          "texto": "Formula y evalúa planes de negocio aplicables a la realidad de la industria agroalimentaria."
        },
        {
          "codigo": "C-RS",
          "texto": "Toma decisiones directivas con responsabilidad social y visión estratégica del entorno."
        }
      ]
    },
    {
      "id": 2,
      "proposito": "Las competencias de la asignatura funcionan como un filtro curricular que ayuda a discriminar entre lo esencial que el estudiante debe demostrar y lo secundario. La asignatura tributa a varias competencias del perfil de egreso de forma simultánea, por lo que las evaluaciones deben enfocarse donde el aporte formativo es más relevante.",
      "aplicacionTitle": "¿Cómo lo aplico en mi asignatura?",
      "aplicacionDesc": "En lugar de medir únicamente si el estudiante recuerda la definición teórica de 'empresa', evalúe si es capaz de administrarla. Integre 'Análisis de Casos' donde el estudiante asuma el rol gerencial para diagnosticar una disfunción operativa en una empresa real del agro."
    },
    {
      "id": 3,
      ...
      "aplicacionTitle": "¿Cómo lo aplico en mi asignatura?",
      "aplicacionDesc": "Alinee la evaluación al verbo del RA. Si un resultado indica 'proponer soluciones fundamentadas a problemas de gestión', una prueba de alternativas es insuficiente. Deberá solicitar un entregable complejo y progresivo, como las diferentes fases del Plan de Negocios."
    },
    {
      "id": 4,
      "proposito": "Es su estrategia para recolectar evidencia válida. Diversificar las formas en que sus estudiantes demuestran su aprendizaje permite evaluar de manera más justa, atendiendo distintos perfiles y reduciendo la ansiedad frente a una única 'prueba final'.",
      "aplicacionTitle": "¿Cómo lo aplico en mi asignatura?",
      "aplicacionDesc": "Equilibre las ponderaciones según la complejidad cognitiva: Utilice Pruebas Escritas (40%) para asegurar el dominio conceptual básico (fases administrativas), Trabajos Prácticos (25%) para aplicar diagnósticos, y un 'Pitch' oral final (20%) para evaluar el desempeño transversal de comunicación y persuasión."
    },
    {
      "id": 5,
      "proposito": "Son las 'reglas del juego' transparentes. Establecer con claridad qué espera observar en un desempeño antes de que los estudiantes comiencen la tarea, disminuye los reclamos de notas, elimina sesgos personales al revisar y agiliza su tiempo de corrección.",
      "aplicacionTitle": "¿Cómo lo aplico en mi asignatura?",
      "aplicacionDesc": "Si va a evaluar un Plan de Negocios, no pida solo un 'buen informe'. Defina dimensiones claras: \n• Dimensión Aplicada: Exige que el VAN y TIR estén correctamente calculados.\n• Dimensión Comunicativa: Exige vocabulario técnico y respuestas asertivas ante la comisión."
    },
    {
      "id": 6,
      "proposito": "Es el formato tangible (pauta, rúbrica, prueba) que materializa sus criterios. Elegir el instrumento idóneo para cada procedimiento no solo garantiza la objetividad, sino que es clave para estructurar una retroalimentación rápida y efectiva sin sobrecargar su agenda docente.",
      "aplicacionTitle": "Herramientas Sugeridas para el Docente",
      "aplicacionDesc": "Explore estos instrumentos diseñados específicamente para las necesidades de AGR 475. Analice cómo puede adaptarlos o utilizarlos directamente en su próxima sesión de evaluación:",
      "examples": [
        {
          "name": "Rúbrica Analítica para Plan de Negocios",
          "source": "(Sugerencia para Evaluación de Proyecto Final)",
          "desc": "Evita calificaciones subjetivas en entregables extensos. Fundamental si usted revisa apoyado por ayudantes o tribunales evaluadores.",
          "rubrica": {
            "title": "Rúbrica Analítica: Plan de Negocios",
            "subtitle": "Focaliza la atención en dimensiones críticas del aprendizaje complejo.",
            "niveles": [
              "Destacado",
              "Competente",
              "En desarrollo",
            ...
            "criterios": [
              {
                "criterio": "Análisis del Entorno Sectorial",
                "niveles": [
                  "Articula un diagnóstico PESTEL exhaustivo y fundamenta oportunidades reales del sector agrícola con fuentes de datos actuales y pertinentes.",
                  "Desarrolla un diagnóstico PESTEL completo y plantea oportunidades coherentes, con respaldo de datos aunque sin profundizar en todas las dimensiones.",
                  "Presenta un diagnóstico parcial del entorno; identifica algunas variables pero sin evidencia del rubro agropecuario que las sustente.",
                  "Entrega un diagnóstico genérico que no utiliza fuentes de datos ni evidencia del sector; las oportunidades planteadas no son verificables."
                ]
              },
              {
                "criterio": "Viabilidad y Proyección Financiera",
                "niveles": [
                  "Construye un flujo de caja coherente, con VAN y TIR correctamente calculados y justificación técnica sólida de la tasa de descuento.",
                  "Elabora un flujo de caja correcto con VAN y TIR bien calculados, aunque la justificación de la tasa de descuento es limitada.",
                  "Presenta un flujo de caja con omisiones de costos relevantes del agro o errores menores que debilitan la proyección.",
                  "Omite costos operativos clave del agro y comete errores de cálculo que invalidan la propuesta financiera."
                ]
              }
            ]
          }
        ...
        {
          "name": "Pauta de Corrección: Estudio de Casos",
          "source": "(Sugerencia para Trabajos Prácticos - 25%)",
          "desc": "Permite una revisión estandarizada y ágil de los talleres grupales, identificando rápidamente fortalezas o vacíos conceptuales en el aula.",
          "modalContent": {
            "title": "Pauta de Evaluación: Análisis de Caso",
            "subtitle": "Calificación rápida basada en niveles de calidad de las respuestas clave.",
            "items": [
              {
                "label": "Diagnóstico (Ponderación: 30%)",
                "content": "El grupo logra separar los 'síntomas' superficiales (ej. baja de ventas) del problema raíz de gestión administrativa que requiere atención."
              },
              {
                "label": "Pertinencia de Solución (Ponderación: 40%)",
                "content": "La mejora propuesta es realista para la escala de la empresa agropecuaria descrita y se fundamenta en las teorías de clase."
              },
              {
                "label": "Vocabulario Técnico (Ponderación: 30%)",
                "content": "Uso apropiado de terminología como 'departamentalización', 'flujo de caja' y 'control de gestión'."
              }
            ]
          }
        },
        {
          "name": "Tabla de Especificaciones: Prueba Escrita",
          "source": "(Sugerencia para la Prueba Parcial - 40%)",
          "desc": "Una matriz que usted diseña *antes* de armar la prueba para asegurar que está midiendo de forma equilibrada sin caer solo en la memorización.",
          "modalContent": {
            "title": "Matriz de Diseño para Pruebas Estructuradas",
            "subtitle": "Asegura cobertura curricular balanceando Reconocimiento y Aplicación.",
            "items": [
              {
                "label": "Nivel de Reconocimiento (Selección Múltiple)",
                "content": "Mide saberes base de forma rápida. \nEjemplo de reactivo: 'De las siguientes funciones, ¿cuál es exclusiva de la fase de Organización dentro del proceso administrativo de un huerto?'"
              },
              {
                "label": "Nivel de Comprensión (Desarrollo Breve)",
                "content": "Mide interrelación de variables. \nEjemplo de reactivo: 'Fundamente cómo un aumento repentino en el tipo de cambio afecta estratégicamente las utilidades de esta empresa frutícola exportadora'."
              }
            ]
          }
        }
  ...
  "references": [
    {
      ...
      "cite": "PUCV (2020). Programa de Asignatura AGR 475-01: Dirección de Empresas. Facultad de Ciencias Agronómicas y de los Alimentos."
    },
    {
