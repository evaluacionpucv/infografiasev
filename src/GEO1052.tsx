...
const course: Course = {
  "code": "GEO 1052",
  "name": "Geografía Urbana y Metropolitana",
  "unit": "Facultad de Ciencias del Mar y Geografía",
  "intro": "Este curso de la Facultad de Ciencias del Mar y Geografía profundiza en la conformación, organización y conflictos del espacio urbano. Esta guía interactiva le acompañará en el diseño y la alineación curricular de sus estrategias formativas y evaluativas.",
  "dimensions": [
    {
      "id": 1,
      "proposito": "¿Hacia dónde apuntamos? Formamos geógrafos capaces de comprender la complejidad de las estructuras urbanas, integrando la dimensión humana y espacial para planificar y resolver problemas del territorio metropolitano.",
      "contexto": "El estudiante integra información del espacio físico y humano, evaluando modelos geográficos para intervenir y planificar el territorio, reconociendo a la ciudad y la urbanización como la máxima expresión de la sociedad.",
      "aplicacionTitle": "Visión Formativa: Ciudad y Sociedad",
      "aplicacionDesc": "Estrategia sugerida: 'Salidas de Campo y Deriva Urbana'. Conecte la teoría con la realidad llevando a los estudiantes a observar el entorno urbano adyacente, interpretando in situ las dinámicas de ocupación, equipamiento y segregación socioespacial.",
      "competencias": [
        {
          "codigo": "C-UR",
          "texto": "Comprende la complejidad de las estructuras urbanas integrando la dimensión humana y espacial."
        },
        {
          "codigo": "C-PL",
          "texto": "Planifica y propone soluciones a problemas del territorio metropolitano."
        },
        {
          "codigo": "C-RI",
          "texto": "Evalúa riesgos territoriales con rigor metodológico y datos espaciales."
        }
      ]
    },
    {
      "id": 2,
      "proposito": "Las competencias de la asignatura integran la lectura del espacio geográfico urbano con herramientas técnicas de planificación local y la evaluación rigurosa de riesgos. La asignatura tributa a varias competencias del perfil del geógrafo de forma simultánea, articulando análisis espacial y toma de decisiones territoriales.",
      "contexto": "Comprende y critica las interrelaciones del espacio geográfico. Diseña métodos para procesar información y resolver problemáticas urbanas y ambientales, aplicando principios de planificación física.",
      "aplicacionTitle": "Estrategias de Aula: Analizando lo Metropolitano",
      "aplicacionDesc": "Estrategia sugerida: 'Estudio de Casos Comparativos'. Analice modelos internacionales (como el Urbanismo Social en Medellín o la gestión en Curitiba) frente a casos locales, para que los estudiantes contrasten diferentes paradigmas de desarrollo y resolución de problemáticas como transporte, vivienda o seguridad."
    },
    {
      "id": 3,
      ...
      "contexto": "RA1: Interpreta la función urbana territorial. RA2: Analiza componentes morfológicos y modelos genéricos. RA3: Evalúa manifestaciones sociales de la ciudad. RA4: Diseña elementos de planificación y metodologías de riesgos físicos.",
      "aplicacionTitle": "Articulación de los R.A.",
      "aplicacionDesc": "Estrategia sugerida: 'Aprendizaje Basado en Problemas (ABP)'. (Para RA3 y RA4). Proponga un problema territorial contingente (ej. asentamientos precarios o campamentos en zonas vulnerables). Los estudiantes deben analizar los discursos dominantes y construir una propuesta metodológica para evaluar el riesgo."
    },
    {
      "id": 4,
      "proposito": "¿Cómo recogeremos la información del aprendizaje? El programa equilibra el levantamiento en terreno (observación visual), conocimientos teóricos de cátedra y un trabajo metodológico aplicado de alta relevancia disciplinar.",
      "contexto": "El curso se evalúa mediante 3 instancias clave obligatorias: Fichas de Observación Urbana (25%), Prueba Formal de Cátedra (35%) y un Trabajo Individual de Desarrollo Metodológico (40%).",
      "aplicacionTitle": "Distribución del Programa Oficial",
      "aplicacionDesc": "• Ficha de Observación (25%): Evalúa el RA1. Ejercicio práctico formalizando mediante un texto los aspectos reconocidos en imágenes urbanas de distintas latitudes.\n• Prueba de Cátedra (35%): Evalúa RA2 y RA3. Examen formal de contenidos teóricos, modelos urbanos y lecturas cartográficas de instrumentos de planificación.\n• Trabajo Individual (40%): Evalúa el RA4. Desarrollo de una metodología de zonificación y evaluación de riesgos (inundaciones, incendios, etc.)."
    },
    {
      "id": 5,
      "proposito": "¿En qué nos fijaremos al corregir? Valoramos la agudeza en la observación morfológica, la correcta lectura de instrumentos formales (ej. Plan Regulador) y el rigor metodológico en cartografía de riesgos.",
      "contexto": "Se observan capacidades como: reconocer principios de organización, leer planimetría urbana y desarrollar zonificaciones que incorporen lógicas de capacidad de carga y amenazas naturales.",
      "aplicacionTitle": "Ejemplos de Criterios Clave",
      "aplicacionDesc": "• Nivel Observacional (RA1/RA2): 'Describe morfológicamente estructuras disímiles e identifica patrones de loteo o equipamiento en unidades gráficas aleatorias'.\n• Nivel Analítico-Crítico (RA3): 'Interpreta discursos urbanos y de época analizando textos eruditos, literatura, cine o expresiones de arte urbano (grafitis/tags)'.\n• Nivel Aplicado (RA4): 'Desarrolla fundadamente una metodología de riesgo considerando variables específicas como remociones en masa, sismos o incendios'."
    },
    {
      "id": 6,
      "proposito": "¿Con qué herramientas calificamos objetivamente? Requerimos pautas de cotejo para la estandarización de las fichas visuales y rúbricas analíticas robustas para el proyecto de riesgo territorial.",
      "contexto": "Las evaluaciones combinan lectura cartográfica/teórica y desarrollo de proyectos analíticos. Cada instrumento debe ajustarse a la naturaleza teórica (cátedra) o procedimental (zonificación) exigida.",
      "aplicacionTitle": "Plantillas de Instrumentos Sugeridos",
      "aplicacionDesc": "A continuación, seleccione un instrumento desplegable para revisar propuestas aplicables al curso Geografía Urbana y Metropolitana:",
      "examples": [
        {
          "name": "Pauta de Valoración: Ficha de Observación",
          "source": "(Evaluación 1 - 25% | RA1)",
          "desc": "Evalúa la capacidad del estudiante para extraer, formalizar e interpretar elementos urbanos desde imágenes o derivas de terreno.",
          "modalContent": {
            "title": "Pauta de Cotejo: Análisis Morfológico Visual",
            "subtitle": "Indicadores para estandarizar la evaluación de las imágenes urbanas analizadas.",
            "items": [
              {
                "label": "1. Identificación de Estructuras",
                "content": "Identifica y nombra correctamente elementos clave como patrones de loteo, trama vial, tipos de infraestructura y equipamiento en la imagen/territorio asignado."
              },
              {
                "label": "2. Aplicación de Conceptos Teóricos",
                "content": "Utiliza un vocabulario geográfico formal (utilidad pública, estructura predial, crecimiento por densidad o expansión) para explicar la organización de la sección territorial."
              },
              {
                "label": "3. Formalización del Texto (Ficha)",
                "content": "La ficha posee una redacción clara, estructura lógica y sistematiza coherentemente las diferencias o similitudes con otras latitudes estudiadas."
              }
            ]
          }
        },
        {
          ...
          "source": "(Evaluación 2 - 35% | RA2, RA3)",
          "desc": "Asegura el balance entre la teoría clásica de ecología urbana y la interpretación aplicada de instrumentos de planificación.",
          "modalContent": {
            "title": "Matriz de Evaluación Escrita",
            "subtitle": "Distribución de ítems según niveles de procesamiento cognitivo urbano.",
            "items": [
              {
                "label": "Nivel 1: Comprensión de Conceptos y Modelos",
                "content": "Foco: Diferenciar conceptos como metropolización, conurbación y urbanización. Reconocer los postulados básicos de los modelos de Ecología Urbana (ej. Chicago)."
              },
              {
                "label": "Nivel 2: Lectura Cartográfica e Instrumental",
                "content": "Foco: Dada la planimetría de un Plan Regulador Comunal u otro instrumento, identificar zonas de uso de suelo, áreas de restricción o la racionalidad instrumental del Estado plasmada en el plano."
              },
              {
                "label": "Nivel 3: Análisis Crítico Socio-Espacial",
                "content": "Foco: Analizar un fragmento literario urbano, texto de época o una imagen de manifestación ciudadana (grafitis), argumentando cómo estas prácticas reflejan la dinámica social en la ciudad."
              }
            ]
          }
        },
        {
          "name": "Rúbrica: Metodología de Zonificación y Riesgos",
          "source": "(Evaluación 3 - Trabajo Individual - 40% | RA4)",
          "desc": "Evalúa el diseño técnico y la fundamentación del proyecto final de aplicación territorial.",
          "rubrica": {
            "title": "Rúbrica Analítica: Proyecto de Riesgo Físico",
            "subtitle": "Centrada en el rigor metodológico para la intervención de problemáticas locales.",
            "niveles": [
              "Destacado",
              "Competente",
              "En desarrollo",
            ...
            "criterios": [
              {
                "criterio": "Diagnóstico de la Unidad Territorial",
                "niveles": [
                  "Justifica sólidamente la elección de la unidad crítica con datos espaciales y socioeconómicos relevantes.",
                  "Justifica la unidad territorial con datos pertinentes, con menor profundidad analítica.",
                  "Describe el lugar con algunos datos, pero sin evidenciar del todo su criticidad territorial.",
                  "Describe el lugar de forma genérica sin aportar datos que evidencien su criticidad."
                ]
              },
              {
                "criterio": "Diseño de Metodología de Riesgos",
                "niveles": [
                  "Construye una secuencia metodológica lógica y fundamentada, cruzando variables de exposición y vulnerabilidad para al menos una amenaza.",
                  "Diseña un método coherente para evaluar la amenaza, con cruce parcial de variables.",
                  "Esboza un método pero sin pasos claros para espacializar u objetivar el nivel de riesgo.",
                  "Enumera amenazas sin establecer un método que permita evaluar el riesgo."
                ]
              },
              {
                "criterio": "Propuesta de Zonificación",
                "niveles": [
                  "Establece zonificación basada en capacidad de carga y propone usos de suelo coherentes para mitigar la amenaza.",
                  "Propone una zonificación pertinente con usos de suelo mayormente coherentes.",
                  "Plantea una zonificación general con débil relación con la amenaza detectada.",
                  "No propone zonificación o esta no responde al diagnóstico realizado."
                ]
              }
            ]
          }
  ...
  "references": [
    {
      ...
      "cite": "Programa de Asignatura: GEO 1052 - Geografía Urbana y Metropolitana. Pontificia Universidad Católica de Valparaíso."
    },
    {
    ...
    {
      "category": "Bibliografía Clave del Curso",
      "cite": "Ascher, F. (2004). Los nuevos principios del urbanismo. Alianza."
    },
    {
      "category": "Bibliografía Clave del Curso",
      "cite": "Capel, H. (2002). La morfología de las ciudades. Vol. I. Del Serbal."
    },
    {
      "category": "Bibliografía Clave del Curso",
      "cite": "Harvey, D. (2014). Ciudades rebeldes: del derecho a la ciudad a la revolución urbana. Akal."
    },
    {
      "category": "Bibliografía Clave del Curso",
      "cite": "Jacobs, J. (2011). Muerte y vida de las grandes ciudades. Capitán Swing Libros."
    }
  ]
};
