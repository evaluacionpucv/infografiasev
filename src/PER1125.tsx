...
const course: Course = {
  "code": "PER 1125",
  "name": "Pensamiento Político Contemporáneo",
  "unit": "Escuela de Periodismo",
  "intro": "Asignatura obligatoria de tercer semestre. Exige un diseño evaluativo que se aleje de pruebas memorísticas, priorizando la capacidad de abstracción, síntesis y argumentación oral y escrita del estudiante de Periodismo.",
  "dimensions": [
    {
      "id": 1,
      "proposito": "Actúa como nuestra brújula formativa. Nos asegura que los contenidos y evaluaciones de Pensamiento Político Contemporáneo tributan directamente a las capacidades críticas que el futuro periodista necesitará en el ejercicio profesional real.",
      "aplicacionTitle": "¿Cómo lo aplico en mi asignatura?",
      "aplicacionDesc": "Antes de diseñar el ensayo o la exposición oral, revise si la instrucción final exige al estudiante 'evaluar debates y acontecimientos de relevancia social con pensamiento crítico'. Si la respuesta es afirmativa, su evaluación está perfectamente alineada.",
      "ejemplo": "Desempeño central esperado: Análisis reflexivo del acontecer nacional e internacional integrando diversas líneas de pensamiento político y cultural occidental.",
      "competencias": [
        {
          "codigo": "C-CR",
          "texto": "Desarrolla pensamiento crítico para analizar la coyuntura política y comunicacional."
        },
        {
          "codigo": "C-TE",
          "texto": "Integra corrientes del pensamiento político contemporáneo en el análisis periodístico."
        },
        {
          "codigo": "C-CO",
          "texto": "Comunica análisis fundamentados con rigor argumentativo y normativo."
        }
      ]
    },
    {
      "id": 2,
      "proposito": "Las competencias de la asignatura traducen el perfil de egreso a la cancha específica del periodismo: definen el 'saber actuar' esperado frente a la coyuntura política y comunicacional. La asignatura tributa a varias competencias del perfil del periodista de forma simultánea, articulando teoría política, análisis crítico y comunicación.",
      "aplicacionTitle": "¿Cómo lo aplico en mi asignatura?",
      "aplicacionDesc": "Diseñe sus clases y talleres (ej. Debates de Coyuntura) obligando al estudiante a movilizar los conocimientos teóricos (ideologías) para resolver o analizar un problema discursivo contemporáneo, superando la mera memorización histórica.",
      "ejemplo": "Foco de la competencia: Comprender la dimensión discursiva de la comunicación y reflexionar sobre las estrategias e intereses ideológicos detrás de la coyuntura."
    },
    {
      "id": 3,
      ...
      "aplicacionTitle": "¿Cómo lo aplico en mi asignatura?",
      "aplicacionDesc": "Utilícelos textualmente para redactar las instrucciones de sus evaluaciones. Por ejemplo, indique explícitamente en la pauta del ensayo que el estudiante debe 'analizar variables sociales' o 'establecer conexiones sociopolíticas'.",
      "ejemplo": "Hitos observables: 1. Analizar variables sociales y políticas de ideologías (s. XX-XXI). 2. Establecer problemas sociopolíticos globales y locales (Latinoamérica/Chile)."
    },
    {
      "id": 4,
      "proposito": "Determina las metodologías óptimas para recoger evidencia válida del aprendizaje. En esta asignatura de alta carga reflexiva, nos alejamos de pruebas de opción múltiple y priorizamos el desempeño analítico.",
      "aplicacionTitle": "¿Cómo lo aplico en mi asignatura?",
      "aplicacionDesc": "Planifique el semestre distribuyendo la carga cognitiva y de trabajo en los tres grandes hitos declarados, ofreciendo retroalimentación formativa antes de la entrega de los productos finales.",
      "ejemplo": "Hitos Evaluativos Oficiales:\n• Exposición Oral de temáticas (30%)\n• Ensayo Escrito reflexivo (30%)\n• Exposición de Lecturas y textos (40%)"
    },
    {
      "id": 5,
      "proposito": "Transparentan, tanto para usted como para sus estudiantes, los ejes de calidad que determinarán el éxito del trabajo, reduciendo significativamente la subjetividad al momento de calificar.",
      "aplicacionTitle": "¿Cómo lo aplico en mi asignatura?",
      "aplicacionDesc": "Defínalos claramente antes de construir sus rúbricas. Enfoque sus criterios en las tres dimensiones clave del periodista crítico: rigor disciplinar, profundidad argumentativa y habilidad comunicacional.",
      "ejemplo": "Dimensiones sugeridas para la pauta:\n• Dominio Teórico (Conexión ideológica)\n• Argumentación Crítica (Postura justificada)\n• Expresión Periodística (Estructura y fluidez oral/escrita)"
    },
    {
      "id": 6,
      "proposito": "Es la herramienta métrica concreta. Permite calificar de forma estandarizada productos complejos (como el ensayo o los debates) facilitando la retroalimentación precisa sobre las brechas de aprendizaje.",
      "aplicacionTitle": "Herramientas sugeridas para el docente",
      "aplicacionDesc": "Socialice estos instrumentos con los estudiantes en el momento en que entrega las instrucciones del trabajo, no al final. Úselos durante la exposición para marcar niveles de logro en tiempo real.",
      "ejemplo": "A continuación, seleccione un instrumento sugerido para explorar su estructura aplicada a las instancias evaluativas de la asignatura:",
      "examples": [
        {
          "name": "Rúbrica Analítica para Ensayo Escrito",
          "source": "Ponderación en Sílabo: 30%",
          "desc": "Ideal para medir el rigor argumentativo, la integración de lecturas y la claridad expositiva.",
          "rubrica": {
            "title": "Rúbrica Analítica: Ensayo Político",
            "subtitle": "Evalúa grados de calidad en la síntesis y la reflexión crítica.",
            "niveles": [
              "Destacado",
              "Competente",
              "En desarrollo",
            ...
            "criterios": [
              {
                "criterio": "Análisis y Argumentación",
                "niveles": [
                  "Desarrolla una tesis clara sostenida por argumentos profundos y referentes teóricos del curso.",
                  "Plantea una tesis y la sostiene con argumentos pertinentes y algunos referentes teóricos.",
                  "Esboza una postura pero la argumentación es débil o poco fundamentada.",
                  "Resumen descriptivo de los textos sin postura crítica."
                ]
              },
              {
                "criterio": "Integración de Corrientes",
                "niveles": [
                  "Relaciona coherentemente las corrientes teóricas con la coyuntura política actual (Chile o Latam).",
                  "Relaciona teoría y coyuntura de forma pertinente, con conexiones algo generales.",
                  "Menciona corrientes y coyuntura pero con conexión débil entre ambas.",
                  "Menciona conceptos aislados sin conexión con el presente."
                ]
              },
              {
                "criterio": "Redacción Periodística",
                "niveles": [
                  "Estructura fluida, argumentación persuasiva, sin errores de formato y con uso normativo de citas.",
                  "Redacción clara y ordenada, con errores menores de formato o citación.",
                  "Redacción comprensible pero con problemas de estructura o citación.",
                  "Redacción confusa, con errores de formato y sin uso normativo de citas."
                ]
              }
            ]
          }
        ...
        {
          "name": "Escala de Valoración para Control de Lecturas",
          "source": "Ponderación en Sílabo: 40%",
          "desc": "Instrumento ágil para monitorear la comprensión de bibliografía extensa en plenarios o controles.",
          "modalContent": {
            "title": "Escala de Frecuencia/Calidad: Lecturas",
            "subtitle": "Verificación del dominio comprensivo de textos fundamentales.",
            "items": [
              {
                "label": "Dominio Conceptual",
                "content": "¿El estudiante explica sin distorsiones las nociones principales del autor asignado (ej. biopolítica, populismo)? [ Escala 1 al 4 ]"
              },
              {
                "label": "Contextualización Histórica",
                "content": "¿Es capaz de ubicar la obra y al autor en su correspondiente periodo y debate social original? [ Escala 1 al 4 ]"
              },
              {
                "label": "Capacidad de Respuesta",
                "content": "¿Argumenta asertivamente al responder las preguntas contra-argumentativas del profesor en el plenario? [ Escala 1 al 4 ]"
              }
            ]
          }
        },
        {
          "name": "Rúbrica para Exposición Temática",
          "source": "Ponderación en Sílabo: 30%",
          "desc": "Diseñada para evaluar tanto la apropiación del contenido como las competencias comunicativas orales.",
          "rubrica": {
            "title": "Rúbrica Analítica: Presentación Oral",
            "subtitle": "Evaluación conjunta de forma (expresión) y fondo (disciplina).",
            "niveles": [
              "Destacado",
              "Competente",
              "En desarrollo",
            ...
            "criterios": [
              {
                "criterio": "Solidez del Mensaje (Fondo)",
                "niveles": [
                  "Explica las corrientes políticas con precisión, diferenciando matices entre autores.",
                  "Explica las corrientes correctamente, con menor diferenciación de matices.",
                  "Explica las corrientes de forma general, con imprecisiones conceptuales.",
                  "Presenta las corrientes con errores conceptuales relevantes."
                ]
              },
              {
                "criterio": "Habilidad Comunicativa (Forma)",
                "niveles": [
                  "Mantiene la atención de la audiencia con tono persuasivo, contacto visual y sin leer los apuntes.",
                  "Comunica con claridad y mantiene el interés, apoyándose ocasionalmente en apuntes.",
                  "La comunicación es irregular; depende con frecuencia de la lectura de apuntes.",
                  "Lee permanentemente los apuntes y no logra conectar con la audiencia."
                ]
              },
              {
                "criterio": "Uso de Evidencia y Medios",
                "niveles": [
                  "Integra recursos audiovisuales que sustentan y ejemplifican con fuerza el argumento.",
                  "Usa recursos audiovisuales pertinentes que apoyan el argumento.",
                  "Incluye recursos con conexión débil con el argumento expuesto.",
                  "No usa recursos o estos no aportan a la argumentación."
                ]
              }
            ]
          }
  ...
  "references": [
    {
      ...
      "cite": "PUCV (2022). Programa de Asignatura PER-1125: Pensamiento Político Contemporáneo. Escuela de Periodismo."
    },
    {
    ...
    {
      "category": "Alineación Constructiva",
      "cite": "Biggs, J. (2005). Calidad del aprendizaje universitario. Narcea Ediciones."
    }
  ]
};
