  ...
  "dimensions": [
    {
      ...
      "competencias": [
        {
          "codigo": "C-CR",
          "texto": "Crea textos poéticos aplicando técnicas expresivas del oficio, más allá de la inspiración espontánea."
        },
        {
          "codigo": "C-SE",
          "texto": "Percibe y expresa situaciones humanas con sensibilidad estética y dominio del lenguaje."
        },
        {
          "codigo": "C-TR",
          "texto": "Dialoga críticamente con la tradición literaria para situar y enriquecer su propia escritura."
        }
      ]
    },
    {
      "id": 2,
      "proposito": "Las competencias de la asignatura apuntan a escribir poesía reconociendo y aplicando técnicas expresivas: un saber-hacer arraigado en el rigor del oficio poético, más que en la simple 'inspiración'. La asignatura tributa a varias competencias del perfil creativo de forma simultánea, articulando sensibilidad estética, dominio técnico y diálogo con la tradición.",
      ...
      "examples": [
        {
          ...
          "rubrica": {
            ...
            "subtitle": "Evalúa la calidad técnica, la curatoría y el proceso de reescritura.",
            "niveles": [
              "Destacado",
              "Competente",
              "En desarrollo",
            ...
            "criterios": [
              {
                "criterio": "Proceso de Edición (Reescritura)",
                "niveles": [
                  "Se observa una clara evolución entre los primeros borradores y la versión final; el estudiante depura el lenguaje eliminando clichés.",
                  "Hay evidencia de reescritura y mejoras entre borradores, aunque persisten algunos pasajes sin depurar.",
                  "La reescritura es superficial: cambios menores que no transforman sustancialmente el texto.",
                  "Los textos finales son idénticos a los primeros borradores; no hay evidencia de trabajo de edición."
                ]
              },
              {
                "criterio": "Dominio de Recursos Expresivos",
                "niveles": [
                  "Emplea recursos retóricos (metáforas, ritmo, silencios) de forma funcional e innovadora, al servicio del tono del poema.",
                  "Usa recursos poéticos con corrección y pertinencia, aunque sin gran originalidad.",
                  "Emplea algunos recursos de manera irregular; por momentos resultan forzados o decorativos.",
                  "Uso forzado, artificial o nulo de los recursos poéticos estudiados en clase."
                ]
              },
              {
                "criterio": "Reflexión Metacognitiva",
                "niveles": [
                  "El texto introductorio reflexiona profundamente sobre los propios hallazgos y dificultades del semestre.",
                  "La reflexión identifica aprendizajes y dificultades, aunque sin profundizar en todos.",
                  "La reflexión es breve o general, con escasa conexión con el proceso propio.",
                  "No incluye reflexión o es puramente descriptiva ('Aquí presento cinco poemas')."
                ]
              }
            ]
          }
