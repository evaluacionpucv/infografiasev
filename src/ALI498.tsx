  ...
  "dimensions": [
    {
      ...
      "competencias": [
        {
          "codigo": "C-AN",
          "texto": "Maneja con propiedad las metodologías de análisis y caracterización de componentes alimentarios."
        },
        {
          "codigo": "C-TE",
          "texto": "Selecciona tecnologías apropiadas para la obtención y uso de componentes alimentarios según el objetivo y la matriz."
        },
        {
          "codigo": "C-CI",
          "texto": "Interpreta literatura científica actualizada para fundamentar decisiones técnicas en el ámbito de los compuestos bioactivos."
        }
      ]
    },
    {
      "id": 2,
      "proposito": "Las competencias de la asignatura se orientan a conocer y aplicar metodologías de estudio de compuestos bioactivos (extracción, separación, caracterización fisicoquímica y biológico-funcional) y a seleccionar la técnica analítica más apropiada según el objetivo y la matriz alimentaria. La asignatura tributa simultáneamente a varias competencias del perfil, integrando conocimiento conceptual, criterio técnico y manejo de literatura científica.",
      ...
      "examples": [
        {
          ...
          "rubrica": {
            ...
            "subtitle": "Cinco criterios ponderados para evaluar la presentación científica.",
            "niveles": [
              "Destacado",
              "Competente",
              "En desarrollo",
            ...
            "criterios": [
              {
                "criterio": "Uso de lenguaje técnico (25%)",
                "niveles": [
                  "Usa terminología especializada de forma precisa y consistente; define términos complejos cuando es necesario.",
                  "Emplea terminología técnica correcta en la mayor parte de la exposición, con imprecisiones puntuales que no afectan la comprensión.",
                  "Usa algunos términos técnicos pero incurre en imprecisiones que evidencian comprensión parcial del tema.",
                  "Utiliza lenguaje coloquial o términos técnicos mal empleados que revelan comprensión superficial."
                ]
              },
              {
                "criterio": "Manejo de conceptos teóricos (35%)",
                "niveles": [
                  "Demuestra comprensión profunda del artículo; conecta los hallazgos con el marco conceptual del curso y señala implicancias para la industria.",
                  "Comprende el artículo y lo relaciona con el marco del curso, aunque no explora todas las implicancias.",
                  "Describe los resultados del artículo con conexiones débiles o incompletas al marco teórico del curso.",
                  "Describe los resultados sin conectarlos con teorías del curso ni con aplicaciones reales."
                ]
              },
              {
                "criterio": "Calidad de la presentación y participación crítica (40%)",
                "niveles": [
                  "El material visual es claro y jerárquico; el grupo responde preguntas con solidez y reconoce las limitaciones del artículo.",
                  "El material es claro y el grupo responde la mayoría de las preguntas, aunque no siempre problematiza el artículo.",
                  "El material es funcional pero recargado; el grupo responde solo preguntas previstas en el guion.",
                  "El material tiene texto excesivo; el grupo tiene dificultad para responder preguntas fuera del guion preparado."
                ]
              }
            ]
          }
