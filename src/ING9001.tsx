...
const course: Course = {
  "code": "ING 9001",
  "name": "Inglés I (Beginner)",
  "unit": "Pedagogía en Química y Cs. Naturales",
  "intro": "Esta asignatura introduce las bases de la comunicación en un segundo idioma (Nivel A1). Sus instancias evaluativas están diseñadas estratégicamente para alejarse de los test tradicionales, buscando medir el desempeño real del estudiante en situaciones comunicativas auténticas integrando las dimensiones lingüística, pragmática y actitudinal.",
  "dimensions": [
    {
      "id": 1,
      "proposito": "Garantiza que nuestras decisiones evaluativas no ocurran en el vacío, sino que tributen directamente a las competencias profesionales declaradas institucionalmente. Evita que la evaluación sea un evento aislado.",
      "aplicacionTitle": "¿Cómo lo aplico en mi asignatura?",
      "aplicacionDesc": "Al diseñar una tarea, pregúntese: ¿Cómo ayuda esta evaluación a que el estudiante se acerque al profesional que la universidad promete formar? En este curso, conectamos el nivel A1 de inglés con la necesidad de tener docentes de ciencias capaces de desenvolverse en entornos académicos globales.",
      "ejemplo": "En vez de un examen teórico escrito, valide su capacidad de integrarse globalmente mediante un 'Role-play de Congreso', donde simulen intercambiar información profesional y personal con investigadores extranjeros.",
      "competencias": [
        {
          "codigo": "CFF",
          "texto": "Comunica ideas básicas en inglés como lengua extranjera en situaciones cotidianas de nivel A1."
        },
        {
          "codigo": "C-IN",
          "texto": "Moviliza de forma integrada conocimientos, habilidades y actitudes frente a situaciones comunicativas desafiantes."
        },
        {
          "codigo": "C-AU",
          "texto": "Desarrolla autonomía y estrategias para el aprendizaje continuo del idioma."
        }
      ]
    },
    {
      "id": 2,
      "proposito": "Las competencias de la asignatura delimitan el 'saber actuar' comunicativo esperado al final del curso, exigiendo la movilización integrada de conocimientos, habilidades y actitudes ante situaciones de nivel A1, más allá de la memorización de contenidos. La asignatura tributa a varias competencias del perfil de forma simultánea.",
      "aplicacionTitle": "¿Cómo lo aplico en mi asignatura?",
      "aplicacionDesc": "Diseñe situaciones evaluativas (auténticas o simuladas) donde el estudiante tenga una necesidad comunicativa real. El estudiante debe resolver el problema utilizando el idioma, priorizando la eficacia del mensaje sobre la perfección gramatical absoluta.",
      "ejemplo": "Situación desafiante: 'Usted debe guiar a un investigador visitante por las instalaciones de su laboratorio'. Esta tarea obliga al estudiante a integrar espontáneamente vocabulario espacial, saludos e instrucciones (imperativos)."
    },
    {
      "id": 3,
      ...
      "aplicacionTitle": "¿Cómo lo aplico en mi asignatura?",
      "aplicacionDesc": "Asegúrese de mantener una alineación constructiva rigurosa: la tarea de evaluación que proponga debe exigir exactamente el mismo nivel cognitivo y procedimental que declara el verbo del Resultado de Aprendizaje.",
      "ejemplo": "Si su RA declara 'Produce mensajes orales básicos para situaciones cotidianas', la evaluación central no puede ser un test de alternativas; ineludiblemente debe requerir que el estudiante hable (ej. exposición oral de sus rutinas)."
    },
    {
      "id": 4,
      "proposito": "Representa el método general o la 'estrategia' mediante la cual recogeremos la evidencia del aprendizaje (ej. pautas de observación, resolución de casos, simulaciones, portafolios).",
      "aplicacionTitle": "¿Cómo lo aplico en mi asignatura?",
      "aplicacionDesc": "Seleccione un procedimiento que resulte auténtico y situado. Pregúntese si los futuros profesionales se enfrentarán a este tipo de formato o desafío en su verdadera vida laboral o académica.",
      "ejemplo": "Para evidenciar comprensión auditiva auténtica, utilice como procedimiento el 'Task-Based Learning'. El estudiante visualiza un video técnico breve y completa colaborativamente un mapa mental, en lugar del clásico 'fill-in-the-blanks'."
    },
    {
      "id": 5,
      "proposito": "Son los 'lentes' con los que valoraremos el desempeño. Transparentan nuestras expectativas, reducen el sesgo al calificar y guían el esfuerzo del estudiante antes de enfrentarse a la tarea.",
      "aplicacionTitle": "¿Cómo lo aplico en mi asignatura?",
      "aplicacionDesc": "Desglose el desempeño esperado en dimensiones clave (ej. Lingüística, Pragmática, Actitudinal). Redacte los criterios en positivo, enfocando la mirada evaluativa en lo que el estudiante logra hacer, más que penalizar el error aislado.",
      "ejemplo": "• Criterio Lingüístico: 'Emplea el presente simple para rutinas'.\n• Criterio Pragmático: 'Mantiene el flujo de la interacción, tolerando pausas naturales'.\n• Criterio Actitudinal: 'Muestra disposición a autocorregirse al comunicarse'."
    },
    {
      "id": 6,
      "proposito": "Materializan y estructuran la calificación (y la retroalimentación) en base a los criterios definidos previamente. Son la herramienta física o digital de registro del docente.",
      "aplicacionTitle": "Herramientas sugeridas para el docente",
      "aplicacionDesc": "Adecúe la herramienta a la naturaleza de la evidencia. Use rúbricas analíticas para calificar grados de calidad en desempeños complejos (presentaciones, debates) y listas de cotejo para verificar la presencia de atributos en productos concretos.",
      "ejemplo": "A continuación, seleccione los distintos instrumentos para explorar ejemplos de su estructura aplicada a las tareas de esta asignatura:",
      "examples": [
        {
          "name": "Rúbrica Analítica: Role-Play",
          "source": "(Evaluación de desempeño oral)",
          "desc": "Ideal para graduar calidades en interacciones complejas, entregando feedback detallado.",
          "rubrica": {
            "title": "Rúbrica Analítica: Interacción A1",
            "subtitle": "Evalúa grados de calidad en la producción oral espontánea.",
            "niveles": [
              "Destacado",
              "Competente",
              "En desarrollo",
            ...
            "criterios": [
              {
                ...
                "niveles": [
                  "Producción clara y comprensible sin esfuerzo por parte del oyente.",
                  "Comprensible, con acento materno marcado que no interfiere en la comunicación.",
                  "Comprensible con esfuerzo; errores frecuentes que obligan a pausas ocasionales.",
                  "Errores que dificultan seriamente la decodificación del mensaje."
                ]
              },
              {
                "criterio": "Adecuación Pragmática",
                "niveles": [
                  "Responde al turno de habla y usa fórmulas de cortesía atingentes al contexto.",
                  "Responde al turno de habla con fórmulas adecuadas, con algún desajuste menor.",
                  "Mantiene la interacción con dificultad; respuestas breves o poco conectadas.",
                  "Respuestas inconexas o silencios prolongados que quiebran la comunicación."
                ]
              }
            ]
          }
        ...
        {
          "name": "Lista de Cotejo: Póster Científico",
          "source": "(Evaluación de producto formal)",
          "desc": "Herramienta binaria de rápida aplicación para asegurar requisitos estructurales mínimos.",
          "modalContent": {
            "title": "Lista de Cotejo: Póster Digital",
            "subtitle": "Verificación (Sí/No) de atributos estructurales y de contenido predefinidos.",
            "items": [
              {
                "label": "Requisito Estructural 1",
                "content": "¿El diseño integra al menos 3 apartados visualmente separados (Hobbies, Rutina, Familia)? [ SÍ / NO ]"
              },
              {
                "label": "Requisito Lingüístico 1",
                "content": "¿Incluye al menos 5 oraciones descriptivas correctas utilizando Presente Simple? [ SÍ / NO ]"
              },
              {
                "label": "Requisito Formal",
                "content": "¿Aplica sistemáticamente mayúsculas al inicio y signos de puntuación de cierre? [ SÍ / NO ]"
              }
            ]
          }
        },
        {
          "name": "Escala de Apreciación Formativa",
          "source": "(Monitoreo Actitudinal de Aula)",
          "desc": "Permite registrar la frecuencia de conductas clave para el aprendizaje durante el semestre.",
          "modalContent": {
            "title": "Escala de Apreciación de Proceso",
            "subtitle": "Frecuencia de observación: Siempre (3) - A veces (2) - Rara vez (1)",
            "items": [
              {
                "label": "Tolerancia a la frustración",
                "content": "Persiste en sus intentos comunicativos en inglés a pesar de no encontrar la palabra exacta de inmediato."
              },
              {
                "label": "Estrategias compensatorias",
                "content": "Hace uso de mímica o solicita aclaraciones en el idioma meta (ej. 'Can you repeat?', 'How do you say...?') para no romper el diálogo."
              }
            ]
          }
        }
  ...
  "references": [
    {
      ...
      "cite": "PUCV (2020). Sílabo ING-9001: Inglés I - Beginner. Pedagogía en Química y Ciencias Naturales."
    },
    {
